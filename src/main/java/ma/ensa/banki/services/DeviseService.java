...
//	String OPEN_EXCHANGE_RATES = environment.getProperty("openExchangeRatesAPIkey");
	...
	public void removeDevise(Long id) throws NotFoundException {

		//vérifier l'existence de la devise
		Devise devise = deviseRepo.findById(id).orElseThrow(() -> new NotFoundException("Aucune devise avec l'id " + id + " n'est trouvée"));
	...
	public double getRate(String currSrc, String currDest) {
		return converter.rate(currSrc.toUpperCase(), currDest.toUpperCase());
	}
}
