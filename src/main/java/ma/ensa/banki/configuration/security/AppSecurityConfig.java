...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Scheduled(cron = "1 30 * * * *")
	public static void backup(String host, String port, String username, String password, String databasename, String sqlname) throws Exception {
		File file = new File("./src/main/resources/backup"+LocalDateTime.now());
		if (!file.exists()) {
			file.mkdir();
		}
